            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email",
                        $"Pentru a confirma emailul <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>apasa-ti aici</a>.");
        ...
        private Utilizator CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Utilizator)}'. " +
                    $"Ensure that '{nameof(Utilizator)}' is not an abstract class and has a parameterless constructor, or alternatively " +
